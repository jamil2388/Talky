...
- Also check the detailed changes from PROJECT_LOGS.md if it exists  
- Before executing your ideas, always articulate the ideas with me. If I give you the signal or approval,
then go ahead for execution

## Coding Style

- Follow the existing coding style
- Follow the existing style of commenting
- Always try to make the functions modular, such that each function is designed to focus on one job, not multiple
- We are following OOP, so whenever there is a scope of generalizing a task and forming a class and its objects, do so
...
- Always update the details of the latest changes in the PROJECT_LOGS.md file under the points of the exact milestone phase step you are in 
